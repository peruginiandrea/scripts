...
mkdir -p $1/
cp /SSD/home/hermione/PascalX/misc/EUR_1KG_phase3_samples.tsv $1/
cp /SSD/home/hermione/PascalX/misc/updateRSID.py $1/
cd $1/
...
do
	# Add rsids
        python3.8 updateRSID.py $i CCDG\_14151\_B01\_GRM\_WGS\_2020-08-05\_chr$i.filtered.shapeit2-duohmm-phased.vcf.gz All_20180418.vcf.gz &
	pwait $3
done
